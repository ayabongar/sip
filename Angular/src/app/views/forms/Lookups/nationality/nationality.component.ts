...
import { csLookups, csNationality, csRank, csTitle } from '../../../../model/lookups';
...
export class NationalityComponent implements OnInit {
  ...
  displayedColumns = ['NationalityID', 'NationalityDescription', 'Active', 'actions'];
  ...
  bindClaimsGridView() {
    ...
    this._lookup.SelectNationalityAllTypes()
      .subscribe
      (
        data => {
  ...
  edit(content, id: string) {
    ...
    this._lookup.SelectNationalityInfoById(id)
      .subscribe
      (
        data => {
          this.object = data[0];
  ...
  onSubmit() {
    ...
    console.log(this.object)
    this._lookup.InsertOrUpdateNationality(this.object)
      .subscribe
      (
        (response) => {
